...
const qaProjects = [
  {
    ...
    highlight: "Caught a state binding bug where Last Name input silently overwrites First Name — blocking checkout entirely.",
  },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-lg mx-auto text-base leading-relaxed">
            ...
            and defect reporting applied to real applications.
          </p>
              ...
              <div className="flex flex-col flex-1 p-5 gap-4">
                ...
                <div className="flex gap-2.5 p-3 bg-yellow-400/20 border border-yellow-500/20 rounded-xl">
                  ...
                  <p className="text-gray-400 text-xs leading-relaxed">
                    <span className="text-yellow-300 font-medium">Notable find: </span>
                    {project.highlight}
                  </p>
                </div>
                ...
                <div className="flex gap-2 mt-auto pt-1">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 rounded-full text-gray-300 hover:text-white text-xs font-medium transition-all duration-200"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 py-2 bg-cyan-900/20 hover:bg-cyan-900/30 border border-cyan-700/30 hover:border-cyan-600/50 rounded-full text-cyan-300 text-xs font-medium transition-all duration-200"
                  >
                    <FaExternalLinkAlt className="text-xs" /> App Tested
                  </a>
                </div>
              </div>
