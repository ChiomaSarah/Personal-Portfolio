  ...
  return (
    <header className="w-full">
      <nav className="bg-purple-900 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <ul
          className={`md:flex md:flex-row md:space-x-6 absolute md:static top-16 left-0 w-full md:w-auto bg-purple-900 md:bg-transparent z-50 transform transition-all duration-500 ease-in-out ${
            open
